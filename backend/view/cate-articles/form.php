        ...
        <div class="box box-primary">
            <div class="box-header">
                <h2 class="box-title" style="text-tranform:uppercase !important;color: #B10007">
                    <?php echo ($id > 0) ? "Cập nhật" : "Tạo mới" ?>  danh mục tin tức <?php echo ($id > 0) ? ': "'.$detail['name_vi'].'"' : ""; ?>
                </h2>
            ...
            <div class="box-body">
            <!-- form start -->
            <form role="form" method="post" id="dataForm" action="controller/CateArticles.php" >
                <?php if($id> 0){ ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <button class="btn btn-warning" type="reset" onclick="location.href='index.php?mod=cate-articles&act=list'">Cancel</button>
                        </td>
                    </tr>                           
                </table>               
                </form>
